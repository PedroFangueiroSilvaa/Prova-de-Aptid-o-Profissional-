...
struct SubmitOrderReviewView: View {
    let idEncomenda: Int
    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    TextField("Conte-nos sobre a sua experiência: entrega, embalagem, atendimento...", text: $comentario, axis: .vertical)
        ...
        .alert("Sucesso", isPresented: $showSuccess) {
            ...
            Text("Avaliação da encomenda enviada com sucesso!")
        }
